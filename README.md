...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.34.1'
```
...
## Release notes
* Method `set(onlineStatusRequestFrequencyInMillis:)` added.
