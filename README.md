...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.34.6'
```
...
```
github "webim/webim-client-sdk-ios" ~> 3.34.6
```
...
## Release notes
* Minimum iOS version downgraded from 10.0 to 8.0.
