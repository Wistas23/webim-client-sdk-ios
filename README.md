...
```
pod 'WebimClientLibrary', :git => 'https://github.com/webim/webim-client-sdk-ios.git', :branch => 'master', :tag => '3.34.0'
```
...
## Release notes
* Method `getLastRatingOfOperatorWith(id:)` fixed.
* Added support for sending multiple files in one message.
